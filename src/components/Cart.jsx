...
const Cart = () => {
  ...
  return (
    <>
      <div
        className={`fixed right-0 top-0 lg:w-[20vw] bg-white h-full w-full p-5 ${
      ...
      <FaShoppingCart
        onClick={() => setActiveCart(!activeCart)}
        className={`rounded-full bg-white shadow-md text-5xl p-3 fixed bottom-4 right-4 ${totalQty>0 && "animate-bounce dealy-500 transition-all"} `}
      />
    </>
  );
};
